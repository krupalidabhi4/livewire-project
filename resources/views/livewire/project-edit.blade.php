                ...
                <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <select wire:model.lazy="country_id"
                                class="form-select @error('country_id') is-invalid @enderror">
                                <option value=""> Select Country </option>
                                @foreach($countries as $country)
                                <option value="{{$country->id}}" @if($country->id == $country_id) selected @endif>{{$country->english_name}}</option>
                                @endforeach
                            </select>
                            @error('country_id')
                                <div class="invalid-feedback">{{ $message }}</div>
                         ...
                         <div class="row mb-3 mt-3">
                            ...
                            <div class="col-md-6">
                                ...
                                @elseif($existingImage)
                                    {{-- DIFFERENCE: show the current saved image --}}
                                    <div class="mt-2">
